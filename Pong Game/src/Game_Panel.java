...
public class Game_Panel extends JPanel implements Runnable {
    ...
    int powerup_P1 = 0;
    int powerup_P2 = 0;
    boolean gameOver = false; // Add this flag
    ...
    public void checkCollision() {
        ...
        if (ball.x <= 0) {
            ...
            if (player2_ActiveStreak == 3 && powerup_P2 == 0) {
                new PowerUp_Sound();
                powerup_P2 = 1;
                powerup_P1 = 0;
                PADDLE_HEIGHT_P1 = 75;
        ...
        if (ball.x >= GAME_WIDTH - BALL_DIAMETER) {
            ...
            if (player1_ActiveStreak == 3 && powerup_P1 == 0) {
                new PowerUp_Sound();
                powerup_P1 = 1;
                powerup_P2 = 0;
        ...
        if ((score.player1 == 10 || score.player2 == 10) && !gameOver) { 
            new Game_End_Sounds(); 
            gameOver = true; 
    ...
    public void drawWinner(Graphics g) {
        ...
        if (score.player1 == 10) {
            g.drawString("Winner", 150, GAME_HEIGHT / 2);
        } else if (score.player2 == 10) {
            g.drawString("Winner", 650, GAME_HEIGHT / 2);
        }
    }
